...
def analyze_excel(file):
    ...
    ct_pivot = rd_ct.pivot_table(index=['Station_ID', 'Date_Time'],columns='PCode',values='Result',aggfunc='mean',fill_value=' ')
    tus_pivot = rd_tus.pivot_table(index=['Station_ID', 'Date_Time'],columns='PCode',values='Result',aggfunc='mean',fill_value=' ')
